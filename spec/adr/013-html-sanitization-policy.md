...
| CSS の走査の総量 | 1 回の `process` につき 8,000,000 歩 | 転送境界が通す 1 バイトあたり 4 回の走査。深さの上限をすり抜ける形に対する最後の歯止め |
