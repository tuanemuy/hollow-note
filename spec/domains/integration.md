...
**鍵の供給元はこのポートの関心事ではない**。版から鍵を引く写像も、現在の版も、アダプターが composition root から受け取った鍵束で解決する。正典は [presentation/index.md](../presentation/index.md)。ドメインに供給元を書くと、鍵の管理を外部の鍵管理基盤に移すたびにドメイン文書を書き換えることになる。
