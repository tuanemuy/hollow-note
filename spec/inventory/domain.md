...
| DOM-common-038 | `OAuthStateStore.take` | `spec/domains/index.md#OAuthStateStoreapplicationportsoauthStateStorets` | 束縛が一致したときだけ state を原子的に取得・削除する（不一致は行を残して `null`） |
